...
HD_PWD='C:/Users/jessm/OneDrive/Documents/University/Year 3/EEE3096S/WorkPackage6/VivadoProjectWP6/WP6_Vivado.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log simple_cpu.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source simple_cpu.tcl
